...
export async function generateEarthquakeMap(earthquakeData: EarthquakeData): Promise<string> {
    ...
    context.fillText(`震源地: ${earthquakeData.latitude.toFixed(2)}°N, ${earthquakeData.longitude.toFixed(2)}°E`, 
                    textX, textY + lineHeight * 5)
...
// 地震データから画像生成用のデータを抽出
export function extractEarthquakeMapData(detail: any): EarthquakeData {
